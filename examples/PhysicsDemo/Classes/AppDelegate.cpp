...
bool AppDelegate::applicationDidFinishLaunching() {
  ...
  if(!glview) {
    ...
    glview =
      GLViewImpl::createWithRect("PhysicsDemo",
  ...
  // director->getRunningScene()->getPhysics3DWorld()->setDebugDrawEnable(true);
  ...
  Scene* scene = CollisionDetectionScene::createScene();
  if (scene == nullptr) {
    return false;
  }
