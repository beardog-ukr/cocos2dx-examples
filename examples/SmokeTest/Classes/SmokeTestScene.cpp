#include "SmokeTestScene.h"

USING_NS_CC;

Scene * SmokeTestScene::createScene() {
  return SmokeTestScene::create();
}
...
static void problemLoading(const char *filename) {
  ...
  printf(
    "Depending on how you compiled you might have to add 'Resources/' in front of filenames in SmokeTestScene.cpp\n");
}
